...
class Parameters : public Parameters_Parent {
   public:
    ...
    bool parseInput( const std::vector<std::string> &arguments ) {
        ...
        numerics_order_timetrafo = params.get( 11 ) ? TIMETRANSFORMATION_MATRIXEXPONENTIAL : TIMETRANSFORMATION_MATRIXEXPONENTIAL;// //FIXME IMETRANSFORMATION_PRECALCULATED;
