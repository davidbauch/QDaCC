...
Sparse System::dgl_phonons_calculate_transformation( double t, double tau ) {
    // Backwards Integral
    if ( parameters.numerics_phonon_approximation_order == QDLC::PhononApproximation::BackwardsIntegral ) {
        // TODO
    ...
    // Matrix Exponential
    else if ( parameters.numerics_phonon_approximation_order == QDLC::PhononApproximation::TransformationMatrix ) {
    ...
    // else if ( parameters.numerics_phonon_approximation_order == QDLC::PhononApproximation::Mixed ) {
    //    double threshold = 0;
    //    for ( auto &p : pulse )
